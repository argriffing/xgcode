"""
Investigate entrywise matrix operations related to Markov asymptotic variance.

This is another way to formalize the idea that it is hard to infer the past.
"""
