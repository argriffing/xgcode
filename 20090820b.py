"""Get some statistics for resequenced chromosomes. [NOWEB]
...
def process(pathnames, good_coverage, bad_coverage, randomization_rate, nseconds, use_pbar):
    ...
    print >> out
    print >> out, 'strain', 'chromosome'
    print >> out, '\t'.join(['homozygous', 'heterozygous', 'wtfzygous'])
    print >> out
    ...
    for chromosome in chromosomes:
        print >> out, chromosome.strain_name, chromosome.chromosome_name
        print >> out, '\t'.join(str(c_hat) for c_hat in chromosome.expected_counts)
        print >> out
    # return the result
...
def main(options, pathnames):
    ...
    use_pbar = True
    nseconds = None
    print process(pathnames, options.good_coverage, options.bad_coverage, options.randomization_rate, nseconds, use_pbar)
