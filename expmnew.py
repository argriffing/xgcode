...
def expm_2009(A):
    ...
    SIAM. J. Matrix Anal. & Appl. 2009, Vol. 31, No. 3, pp. 970--989
    """
    # XXX I don't know how sparse matrices work.
    # XXX OK this might not be so easy unless I get a 'normest' function
    # which estimates the 1-norm of:
    # - a matrix M to a power t
    # - the product of a sequence of matrices M1 * M2 * M3 * ...
    pass

def normest_power(A, t):
    """block 1-norm power method

    This is Algorithm 2.2 in the reference.
    ...
    SIAM. J. Matrix Anal. & Appl. 2009, Vol. 21, No. 4, pp. 1185--1201
    """
    pass
