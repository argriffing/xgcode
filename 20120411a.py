"""
Run BEAST on several column-permuted sub-alignments. [UNFINISHED]
...
def main(args):
    ...
    if args.run == 'hpc':
        adapter = Adapter(g_start_stop_pairs, args.nsamples)
        r = hpcutil.RemoteBrc(adapter)
        ...
        table_string, scripts = beasttut.get_table_string_and_scripts_from_logs(
                g_start_stop_pairs, adapter.local_log_paths, args.nsamples)
